...
import { compensateScrollbarWidth } from '@/js/common/plugins';
...
function showModal(
    id,
    { onShown = null, onClosed = null, removeOnClose = false, setLocalStorage = false } = {}
) {
    MicroModal.show(id, {
        disableScroll: true,
        disableFocus: true,
        ...
        onClose(modal) {
            if(setLocalStorage)
                localStorage.setItem('hideDeliveryAddressModal', 1);
